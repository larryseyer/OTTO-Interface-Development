...
class StateManager {
  ...
  commitTransaction() {
    ...
    if (this.debugMode) {
      console.log(`StateManager: Transaction "${transaction.name}" committed (${transaction.duration}ms)`);
    }
  ...
  rollbackTransaction() {
    ...
    if (this.debugMode) {
      console.log(`StateManager: Transaction "${transaction.name}" rolled back`);
    }
  ...
  getStats() {
    return {
      ...
      currentTransaction: this.currentTransaction ? this.currentTransaction.name : null
    };
  }
