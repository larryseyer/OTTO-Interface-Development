...
class ButtonComponent extends UIComponent {
  ...
  setupEventListeners() {
    ...
    this.addEventListener(this.element, 'mouseup', (e) => this.handleMouseUp(e));
    this.addEventListener(this.element, 'mouseleave', (e) => this.handleMouseLeave(e));
    this.addEventListener(this.element, 'mouseenter', (e) => this.handleMouseEnter(e));
    
    // Touch events
    this.addEventListener(this.element, 'touchstart', (e) => this.handleTouchStart(e));
    this.addEventListener(this.element, 'touchend', (e) => this.handleTouchEnd(e));
  ...
  initializeChildren() {
    this.buttons.forEach((buttonConfig, index) => {
      const button = new ButtonComponent({
        ...buttonConfig,
        buttonType: this.groupType === 'radio' ? 'radio' : buttonConfig.buttonType,
