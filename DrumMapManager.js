class DrumMapManager {
      ...
      if (response.ok) {
        ...
        for (const mapId of index.maps) {
          const mapResponse = await fetch(
            `/Assets/DrumMaps/factory/${mapId}.json`,
          );
          if (mapResponse.ok) {
  ...
  getGeneralMidiMap() {
    return {
      ...
      mapping: {
        ...
        37: {
          samplePath: "sidestick.wav",
          mixerChannel: "sideStick",
          articulation: "main",
        },
        38: {
        ...
        40: {
          samplePath: "snare2.wav",
          mixerChannel: "snare",
          articulation: "electric",
        },
        41: {
          samplePath: "tom_low2.wav",
          mixerChannel: "tom5",
          articulation: "main",
        },
        42: {
          samplePath: "hihat_closed.wav",
          mixerChannel: "hihat",
          articulation: "closed",
        },
        43: {
          samplePath: "tom_low.wav",
          mixerChannel: "tom4",
          articulation: "main",
        },
        44: {
          samplePath: "hihat_pedal.wav",
          mixerChannel: "hihat",
          articulation: "pedal",
        },
        45: {
          samplePath: "tom_mid2.wav",
          mixerChannel: "tom3",
          articulation: "main",
        },
        46: {
          samplePath: "hihat_open.wav",
          mixerChannel: "hihat",
          articulation: "open",
        },
        47: {
          samplePath: "tom_mid.wav",
          mixerChannel: "tom2",
          articulation: "main",
        },
        48: {
          samplePath: "tom_high2.wav",
          mixerChannel: "tom2",
          articulation: "high",
        },
        49: {
          samplePath: "crash.wav",
          mixerChannel: "crash1",
          articulation: "main",
        },
        50: {
          samplePath: "tom_high.wav",
          mixerChannel: "tom1",
          articulation: "main",
        },
        51: {
        ...
        52: {
          samplePath: "crash2.wav",
          mixerChannel: "crash2",
          articulation: "chinese",
        },
        53: {
          samplePath: "ride_bell.wav",
          mixerChannel: "bell",
          articulation: "main",
        },
        54: {
          samplePath: "tambourine.wav",
          mixerChannel: "splash",
          articulation: "tambourine",
        },
        55: {
          samplePath: "splash.wav",
          mixerChannel: "splash",
          articulation: "main",
        },
        56: {
          samplePath: "cowbell.wav",
          mixerChannel: "bell",
          articulation: "cowbell",
        },
        57: {
          samplePath: "crash3.wav",
          mixerChannel: "crash3",
          articulation: "main",
        },
        59: {
          samplePath: "ride2.wav",
          mixerChannel: "ride",
          articulation: "ride2",
        },
      },
  ...
  setActiveMap(mapId, type = "factory") {
    const map =
      type === "factory"
        ? this.factoryMaps.get(mapId)
        : this.customMaps.get(mapId);
    if (map) {
  ...
  createCustomMap(name, baseMapId = null) {
    ...
    if (baseMapId) {
      ...
      const baseMap =
        this.factoryMaps.get(baseMapId) || this.customMaps.get(baseMapId);
      if (baseMap) {
